...
import { Menu, X, Activity, Server, LayoutDashboard, Cpu, Gauge, Heart, Logs } from "lucide-react";
...
//   // ---------- SCROLL OFFSET CONFIGURATION ----------
//   // Set to false to disable custom offset and revert to default scrollIntoView behavior.
//   // Set to true to use the custom offset defined below.
//   const ENABLE_CUSTOM_OFFSET = true;
//   // How many pixels to offset from the top of the target section (for non‑overview sections).
//   // Increase if the section stops too low (i.e., you want it higher up).
//   // Decrease if it stops too high (i.e., you want it lower).
//   // Set to 0 to match the default behavior (but still uses window.scrollTo).
//   const CUSTOM_OFFSET_PX = 80;
//   // -------------------------------------------------
...
//     if (element) {
//       if (ENABLE_CUSTOM_OFFSET) {
//         // Custom offset: overview goes to the very top, others use CUSTOM_OFFSET_PX.
//         const offset = id === "overview" ? 0 : CUSTOM_OFFSET_PX;
//         const elementPosition = element.getBoundingClientRect().top + window.pageYOffset;
//         window.scrollTo({ top: elementPosition - offset, behavior: "smooth" });
//       } else {
//         // Default behavior: align the top of the element with the top of the viewport.
