...
export default function TextDashboard({ 
  ...
  }, [copySnapshot, onExitTextDash, logLimit, serviceLimit, onRefresh]);
      ...
      <div className="max-w-6xl mx-auto">
        <div className="border-b border-white/20 pb-2 mb-4">
          <div className="flex justify-between items-start flex-wrap gap-2">
            <div>
              <div className={`text-xl font-bold tracking-tight transition-all duration-200 ${isTitleFlashing ? 'text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]' : ''}`}>
                {dashboardName}
              </div>
